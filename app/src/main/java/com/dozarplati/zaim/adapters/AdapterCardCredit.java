...
public class AdapterCardCredit extends RecyclerView.Adapter<AdapterCardCredit.ViewHolder> {

    private List<Cards_credit> posts;

    public AdapterCardCredit(List<Cards_credit> posts) {
        this.posts = posts;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        Cards_credit card = posts.get(position);
        ...
        holder.body_card_desc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("mode", "cardCredit");
