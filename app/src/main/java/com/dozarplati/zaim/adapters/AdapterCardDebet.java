...
public class AdapterCardDebet extends RecyclerView.Adapter<AdapterCardDebet.ViewHolder> {

    private List<Cards_debit> posts;

    public AdapterCardDebet(List<Cards_debit> posts) {
        this.posts = posts;
    }
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        Cards_debit card = posts.get(position);
        ...
        holder.body_card_desc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("mode", "cardDebet");
