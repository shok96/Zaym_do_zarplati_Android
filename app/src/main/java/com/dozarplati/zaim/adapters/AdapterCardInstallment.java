...
public class AdapterCardInstallment extends RecyclerView.Adapter<AdapterCardInstallment.ViewHolder> {

    private List<Cards_installment> posts;

    public AdapterCardInstallment(List<Cards_installment> posts) {
        this.posts = posts;
    }

    @Override
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.card_zaymer, parent, false);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, final int position) {
        Cards_installment card = posts.get(position);
        ...
        holder.body_text_summ.setText(String.format("%s %s %s %s %s",
                ...
                card.getSummMax(), card.getSummPostfix()));
        ...
        holder.body_card_desc.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("mode", "cardInstallment");
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageView head_logo, visa, mir, mastercard;
