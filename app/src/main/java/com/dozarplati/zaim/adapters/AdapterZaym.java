...
public class AdapterZaym extends RecyclerView.Adapter<AdapterZaym.ViewHolder> {

    private List<Loans> posts;

    public AdapterZaym(List<Loans> posts) {
        this.posts = posts;
    }
